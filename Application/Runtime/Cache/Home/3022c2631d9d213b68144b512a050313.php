...
<body id="list_style_2" class="xh_body">
...
<script type="text/javascript">
    ...
    <div id="xh_container">
        <div id="xh_content">
         <div class="path"><a href='/'>主页</a> > <a href=''><?php echo ($pname["name"]); ?></a>  </div>
            <ul style="margin-top: 40px;">
            <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "暂无文章" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="xh_area_h_3">
                    ...
                    <div class="r ofh">
                        ...
                        <div class="arrlist_entry ofh"><?php echo (msubstr(htmlspecialchars_decode($vo["brief"]),0,80)); ?>...</div>
                    </div>
                        <div class="b">
                ...
                </li><?php endforeach; endif; else: echo "暂无文章" ;endif; ?>
        </ul>
...
<script type="text/javascript">
    ...
    for (var i=0; i<mobileAgent.length; i++){
        ...
        isMobile = true; 
        location.href = "http://www.jiaown.com/Wap/Article/newslist";
        break; 
        } 
    } 
</script>