...
<title><?php echo ($paper["title"]); ?>--<?php echo (C("TITLE")); ?></title>
<meta name="description" content="<?php echo ($paper["des"]); ?>" />
<meta name="keywords" content="<?php echo ($paper["keywords"]); ?>" />
        ...
        <div id="container">
            <div id="content">
                <div class="post" style="border-right: solid 1px #000000;margin-top: 10px;padding-right:40px;">
                    ...
                    <div class="path"><a href='/'>主页</a> > <a href='javascript:;'><?php echo ($paper["title"]); ?></a></div>
...
<script type="text/javascript">
    ...
    for (var i=0; i<mobileAgent.length; i++){
        ...
        isMobile = true; 
        location.href = "http://www.jiaown.com/Wap/About/index/aid/9";
        break; 
        } 
    } 
</script>